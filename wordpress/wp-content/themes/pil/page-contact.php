...
">
  ...
  <?php echo $adress2;?> 
    ...
    <a href="https://www.google.be/maps/place/Le+P%C3%B4le+Image+de+Li%C3%A8ge/@50.6322879,5.584186,16.65z/data=!4m9!1m2!2m1!1spole+image!3m5!1s0x47c0f0abf7d8c7d3:0xcafe05be0243b139!8m2!3d50.6328806!4d5.5877712!15sCgpwb2xlIGltYWdlkgEQY29ycG9yYXRlX29mZmljZQ">Itineraire <svg id="SvgjsSvg1001" width="10" height="10" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"><defs id="SvgjsDefs1002"></defs><g id="SvgjsG1008" transform="matrix(1,0,0,1,0,0)"><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="svg-inline--fa fa-map-marker-alt fa-w-12" data-icon="map-marker-alt" data-prefix="fas" viewBox="0 0 384 512" width="10" height="10"><path fill="#ffc33b" d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z" class="colorcurrentColor svgShape"></path></svg></g></svg></a>
